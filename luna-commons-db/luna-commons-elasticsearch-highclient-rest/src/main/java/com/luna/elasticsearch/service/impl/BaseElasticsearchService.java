package com.luna.elasticsearch.service.impl;
...
public abstract class BaseElasticsearchService {
    ...
    protected void createIndexRequest(String index) {
        try {
            ...
            request.settings(
                Settings.builder().put("index.number_of_shards", elasticsearchProperties.getIndex().getNumberOfShards())
    ...
    protected void updateRequest(String index, String id, Object object) {
        try {
            ...
            throw new ElasticsearchException(ResultCode.ERROR_SYSTEM_EXCEPTION, "更新索引 {" + index + "} 数据 {" + object + "} 失败");
        }
    }
    ...
    protected void deleteRequest(String index, String id) {
        try {
            ...
            throw new ElasticsearchException(ResultCode.ERROR_SYSTEM_EXCEPTION, "删除索引 {" + index + "} 数据id {" + id + "} 失败");
        }
    }
