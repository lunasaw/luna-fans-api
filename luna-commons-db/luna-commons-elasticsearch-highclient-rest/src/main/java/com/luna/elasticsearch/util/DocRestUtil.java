...
public class DocRestUtil<T> {
    ...
    public String indexAddDoc(String index, String id, Object source) {
        try {
            IndexResponse response = restHighLevelClient.index(buildIndexRequest(index, id, source), RequestOptions.DEFAULT);
    ...
    public Map<String, Object> getDocById(String index, String id, String includes) {
        try {
            GetResponse response = restHighLevelClient.get(buildGetRequest(index, id, includes), RequestOptions.DEFAULT);
