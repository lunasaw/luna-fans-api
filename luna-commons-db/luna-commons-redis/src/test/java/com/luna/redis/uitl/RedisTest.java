...
public class RedisTest extends RedisApplicationTest {
    ...
    public void testObj() {
        ...
        boolean set = redisUtil.set(Person.Table, JSON.toJSONString(personList), 30);
        System.out.println(set);
        System.out.println(redisUtil.get(Person.Table));
    }

    @Test
    public void btest() {
        long expire = redisUtil.getExpire(Person.Table);
        System.out.println(expire);
    }

    @Test
    public void ctest() {
        boolean luna = redisUtil.expire("luna", 30);
        System.out.println(luna);
    }

    @Test
    public void dtest() {
        boolean luna = redisUtil.hasKey("luna");
        System.out.println(luna);
    }

    @Test
    public void etest() {
        redisUtil.del("luna", "luna:test:陈章月", "content_2");
    }

    @Test
    public void atest() {
        redisUtil.deleteKey("luna", "luna:test:陈章月:", "content_2");
    }
}
