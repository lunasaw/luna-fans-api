...
public class BaseExcelUtil<T> {
    private static final Logger    log       = LoggerFactory.getLogger(BaseExcelUtil.class);
    ...
    public BaseExcelUtil(Class<T> clazz) {
        this.clazz = clazz;
    }
     ...
     * @param filename 文件名称
     */
    public static String getAbsoluteFile(String basePath, String filename) {
        String downloadPath = FileProfileConfigValue.getDownloadPath(basePath) + filename;
