...
public class BaiduLanguageProcessingApi {
     ...
     * @throws IOException
     */
    public static String correction(String text) throws IOException {
     ...
     * @throws IOException
     */
    public static String similarityText(String text1, String text2, String model) throws IOException {
     ...
     * @throws IOException
     */
    public static String similarityWords(String word1, String word2) throws IOException {
        String body = "{\n" +
            "    \"word_1\":\"" + word1 + "\",\n" +
            "    \"word_2\":\"" + word2 + "\"\n" +
            "}";
