...
public class BaiduOcrApi {
     ...
     * @throws IOException
     */
    public static List<String> baiDuOcr(String base64String) throws IOException {
     ...
     * @throws IOException
     */
    public static List<Word> baiduOcrAndAddress(String base64String) throws IOException {
     ...
     * @throws IOException
     */
    public static List<Word> baiduOcrAndAddressNormal(String base64String) throws IOException {
     ...
     * @throws IOException
     */
    private static List<Word> getWords(HttpResponse httpResponse) throws IOException {
        JSONObject response = HttpUtils.getResponse(httpResponse);
