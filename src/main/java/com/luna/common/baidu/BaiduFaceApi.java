...
public class BaiduFaceApi {
     ...
     * @throws IOException
     */
    public static List<Face> faceDetect(String base64Str) throws IOException {
     ...
     * @throws IOException
     */
    public static Double faceMathch(String base64Str1, String base64Str2) throws IOException {
        String s = "[\n" +
            "  {\n" +
            "\t\t\"image\": \"" + base64Str1 + "\",\n" +
            "\t\t\"image_type\": \"BASE64\",\n" +
     ...
     * @throws IOException
     */
    public static boolean checkLive(String base64Str) throws IOException {
        String s = "[{\n" +
            "\t\"image\": \"" + base64Str + "\",\n" +
            "\t\"image_type\": \"BASE64\",\n" +
     ...
     * @throws IOException
     */
    public static Map<String, String> checIdCard(String base64Str) throws IOException {
